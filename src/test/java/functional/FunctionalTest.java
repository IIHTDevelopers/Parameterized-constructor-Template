...
public class FunctionalTest {
	...
	String filePath = "src/main/java/com/yaksha/assignment/ParameterizedConstructorAssignment.java";
	...
	public void testMethodOperationsOnly() throws Exception {
		...
		boolean result = autoGrader.testParameterizedConstructor(filePath);
